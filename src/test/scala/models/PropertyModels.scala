...
final case class PropertyAssessmentContexted(
  properties: List[Property]
)

object PropertyAssessmentContexted {
  implicit val format: OFormat[PropertyAssessmentContexted] = Json.format[PropertyAssessmentContexted]
}
